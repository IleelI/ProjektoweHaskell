...
/* package first-project-haskell-0.1.0.0 */
#ifndef VERSION_first_project_haskell
#define VERSION_first_project_haskell "0.1.0.0"
#endif /* VERSION_first_project_haskell */
#ifndef MIN_VERSION_first_project_haskell
#define MIN_VERSION_first_project_haskell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_first_project_haskell */
...
#define CURRENT_COMPONENT_ID "first-project-haskell-0.1.0.0-D8oTSpGgW7A5bfvAnoxDpo-first-project-haskell"
